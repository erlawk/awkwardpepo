...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputMobileNumber = (EditText) findViewById(R.id.mobileNumber);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !mobileNumber.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    registerUser(name, mobileNumber, email, password);
                } else {
     ...
     * */
    private void registerUser(final String name, final String mobileNumber, final String email,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(userID, name, email, mobileNumber);
